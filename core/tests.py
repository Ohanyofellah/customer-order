...
class CustomerOrderTestCase(TestCase):
    def setUp(self):
        ...
        self.customer = Customer.objects.create(
            name="John Doe", code="JD001", phone="+254769525570", email="felixohanyo@gmail.com"
        )
    ...
    def test_customer_creation(self):
        ...
        self.assertEqual(customer.email, "felixohanyo@gmail.com")
    ...
    def test_customer_create_view(self):
        response = self.client.post(
            ...
            {'name': 'Jane Doe', 'code': 'JD002', 'phone': '+254758744987', 'email': 'felixohanyo@gmail.com'}
        )
    ...
    def test_customer_create_view_post_invalid(self):
        response = self.client.post(
            reverse('customer_add'),
            {'name': '', 'code': '', 'phone': '+254758744987', 'email': 'invalid'}
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_api_customer_create(self):
        response = self.api_client.post(
            ...
            {'name': 'Bob Smith', 'code': 'BS001', 'phone': '+254769525570', 'email': 'felixohanyo@gmail.com'}
        )
