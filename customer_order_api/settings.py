...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='felixohanyo@gmail.com')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='huvh fuid xlsb wppt')
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='felixohanyo@gmail.com')
ADMIN_EMAIL = config('ADMIN_EMAIL', default='felixohanyo@gmail.com')
